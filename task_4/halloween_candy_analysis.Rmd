...
# pivoting 2015 table
boing_boing_candy_2015 <- boing_boing_candy_2015 %>% 
  pivot_longer(4:96, names_to = "candy name", values_to = "review")
```
...
boing_boing_candy_2015 <- boing_boing_candy_2015 %>% 
  select(#"id", 
         "going_trick_or_treating", "gender", "age", "country", "state", "candy name", "review")
```

```{r}
# pivoting 2016 table
boing_boing_candy_2016 <- boing_boing_candy_2016 %>% 
  pivot_longer(6:105, names_to = "candy name", values_to = "review")
```

```{r}
#pivoting 2017 table
boing_boing_candy_2017 <- boing_boing_candy_2017 %>% 
  pivot_longer(6:108, names_to = "candy name", values_to = "review")
```
...
```{r}
# Checking ages are an appropriate range 
boing_boing_candy_2015_to_2017 %>% 
  filter(age > 122) %>% 
  mutate(age = NA_integer_) 
```
...
boing_boing_candy_2015_to_2017_clean %>% 
    ...
    summarise(average_age = mean(age, nm.rm = TRUE))
```
